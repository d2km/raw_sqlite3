...
-define(SQLITE_OPEN_DELETEONCLOSE, 16#00000008).
-define(SQLITE_OPEN_EXCLUSIVE, 16#00000010).
-define(SQLITE_OPEN_AUTOPROXY, 16#00000020).
-define(SQLITE_OPEN_URI, 16#00000040).
-define(SQLITE_OPEN_MEMORY, 16#00000080).
-define(SQLITE_OPEN_MAIN_DB, 16#00000100).
-define(SQLITE_OPEN_TEMP_DB, 16#00000200).
-define(SQLITE_OPEN_TRANSIENT_DB, 16#00000400).
-define(SQLITE_OPEN_MAIN_JOURNAL, 16#00000800).
-define(SQLITE_OPEN_TEMP_JOURNAL, 16#00001000).
-define(SQLITE_OPEN_SUBJOURNAL, 16#00002000).
-define(SQLITE_OPEN_MASTER_JOURNAL, 16#00004000).
...
-define(SQLITE_OPEN_WAL, 16#00080000).
